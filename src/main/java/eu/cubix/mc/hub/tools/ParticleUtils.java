...
public enum ParticleUtils {
     ...
     *
     * @param offsetX Maximum distance manager can fly away from the center on the x-axis
     * @param offsetY Maximum distance manager can fly away from the center on the y-axis
     * @param offsetZ Maximum distance manager can fly away from the center on the z-axis
     * @param speed Display speed of the manager
     * @param amount Amount of manager
     ...
     * <p>
     * This class is part of the <b>ParticleUtils Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
     * @since 1.7
     */
    ...
    public static final class ParticlePacket {
            ...
            try {
                ...
                if (version < 8) {
                    ...
                    if (data != null) {
                        ...
                        Reflection.setValue(packet, true, "k", effect == ParticleUtils.ITEM_CRACK ? packetData : new int[] { packetData[0] | (packetData[1] << 12) });
                    }
                }
         ...
         *
         * @param center Center location of the effect
         * @param range Range in which players will receive the packet (Maximum range for manager is usually 16, but it can differ for some types)
