...
//	ITEM_TAKE("take", 40, 8), Doesn't support 1.13 Particle
     ...
     */
    private static void isWater(Location location) {
                ...
                try {
                    ...
                    if (version < 8) {
                        ...
                        if (data != null) {
                            ...
                            Reflection.setValue(packet, true, "k", effect == Particles.ITEM_CRACK ? packetData : new int[]{packetData[0] | (packetData[1] << 12)});
                        }
                    }
